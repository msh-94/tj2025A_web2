...
// [2] 백틱 : 문자열 템플릿 , 문자열내 연산식 JS표현식을 연결할때 사용한다. 
...
// [5] 함수 
function fun1( parm1 , parm2 ){ } // 선언적 함수
const fun2 = function( parm1 , parm2 ){ } // 익명 함수 선언
const fun3 = ( parm1 , parm2 ) => { } // 화살표 함수 선언
const fun4 = ( parm1 , parm2 = "강호동" ) => { } // 5-4 : 매개변수의 기본값
...
// [9] async/await 동기화
    // 1. 비동기 , fetch/axios , fetch 함수는 원래 비동기 래퍼( new Promise ) 이다
const method1 = () => {
    fetch( "url" )
...
const method2 = async () => {
    ...
    // ***** Promise : await은 promise를 사용하는 함수들에 적용된다 *****
