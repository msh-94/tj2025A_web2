...
class AopClass{
    ...
    public void check1(){
        System.out.println("@Before [코로나] 열 체크");
    }// func end
    ...
    // [4-3]
    // @After("execution( 리턴타입 패키지/클래스경로.메소드명( 매개변수타입 , 매개변수타입 ) )")
...
@RestController class AopController{
    ...
    @GetMapping("/day08/aop") public void method(){ // http://localhost:8080/day08/aop
        ...
        aopService.enter3("유재석"); // 서비스 메소드 호출
    }// func end
}// class end
